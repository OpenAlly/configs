...
export const rule = createRule({
  ...
  meta: {
    docs: {
      description: "Disallow legacy __dirname and __filename patterns in favor of " +
        "import.meta.dirname and import.meta.filename"
    },
    messages: {
      preferImportMetaFilename: "Use 'import.meta.filename' instead of " +
        "'url.fileURLToPath(import.meta.url)'",
      preferImportMetaDirname: "Use 'import.meta.dirname' instead of " +
